...
<body class="body" style="margin: 0; padding: 0; background-color: #0a0d0f; color: #e8f0f7; font-family: 'DM Sans', Arial, Helvetica, sans-serif; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;">
          ...
          <tr>
            <td style="padding: 0;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width: 100%; border-collapse: collapse;">
                      ...
                      <tr>
                        ...
                        <td class="stack-column-right" valign="middle" align="right" style="width: 32%; padding: 0; text-align: right;">
                          <div class="stack-column-right-inner" style="text-align: right;">
                            <span class="header-glass" style="display: inline-block; padding: 8px 13px; border: 1px solid #2b4a42; background-color: #152129; color: #00e5a0; font-size: 11px; line-height: 1; letter-spacing: 1.5px; text-transform: uppercase; white-space: nowrap; font-family: 'DM Mono', 'Courier New', Courier, monospace; border-radius: 999px;">
                ...
                <tr>
                  <td class="section-padding" style="padding: 32px 34px 18px 34px; background-color: #10171e;">
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width: 100%; border-collapse: collapse;">
                      <tr>
                        <td style="padding: 0 0 14px 0; color: #fdf6e3; font-size: 30px; line-height: 34px; font-weight: 700; letter-spacing: -0.02em; font-family: 'Syne', Arial, Helvetica, sans-serif;">
                          Your login verification code
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 28px 0; color: #7a98b3; font-size: 14px; line-height: 24px; font-family: 'DM Sans', Arial, Helvetica, sans-serif;">
                          Use the one-time password below to complete your sign-in for <strong style="color: #a5bbcf !important; font-weight: 700;"><span style="display: inline-block; white-space: nowrap !important; color: #a5bbcf !important; text-decoration: none !important;">${displayEmail}</span></strong>. This code is short-lived and can only be used once.
                        </td>
                      </tr>
                      <tr>
                          ...
                          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width: 100%; border-collapse: separate; border-spacing: 0; background-color: #12211d; border: 1px solid #1f5f4b; border-radius: 20px;" class="otp-panel" bgcolor="#12211d">
                            <tr>
                              <td style="padding: 28px 20px 26px 20px; text-align: center; background-color: #12211d; border-radius: 20px;">
                                <div style="margin: 0 0 12px 0; color: #00e5a0; font-size: 11px; line-height: 16px; letter-spacing: 2px; text-transform: uppercase; font-family: 'DM Mono', 'Courier New', Courier, monospace;">
                                  One-Time Password
                                </div>
                                <div class="otp-code" style="margin: 0 0 18px 0; color: #fdf6e3; font-size: 38px; line-height: 42px; font-weight: 700; letter-spacing: 8px; text-align: center; font-family: 'DM Mono', 'Courier New', Courier, monospace;">
                                  ${displayOtp}
                                </div>
                                <span class="expire-pill" style="display: inline-block; padding: 7px 14px; border: 1px solid #7f1d1d; background-color: #2b1417; color: #f87171; font-size: 11px; line-height: 14px; letter-spacing: 1px; text-transform: uppercase; font-family: 'DM Mono', 'Courier New', Courier, monospace; border-radius: 999px;">
                            ...
                            <tr>
                              <td style="padding: 0 32px 0 32px;">
                                <div style="height: 1px; line-height: 1px; font-size: 0; background: linear-gradient(90deg, rgba(0, 229, 160, 0), rgba(0, 229, 160, 0.85) 50%, rgba(0, 229, 160, 0));">&nbsp;</div>
                              </td>
                            </tr>
                          </table>
                        </td>
